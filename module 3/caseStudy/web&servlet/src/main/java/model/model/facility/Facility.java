...
public class Facility {
    ...
    public Facility(int id, String name, int area, double cost, int maxPeople, int rentTypeId,
    ...
    public Facility(int id, String name, int area, double cost, int maxPeople, int rentTypeId,
                    String standardRoom, String desriptionOtherConvenience, int numberOfFloors, int facilityTypeId) {
        this.id = id;
        this.name = name;
        this.area = area;
        this.cost = cost;
